 ...
 */
package com.sunney.modules.type;
 ...
 * 
 * @author zhuzhi.lcm
 * @version $Id: Money.java,v 1.1 2005/04/06 13:26:01 leon Exp $
 */
public class Money implements Serializable, Comparable {
     ...
     * @return
     */
    public static Money getMinMoney(String currencyCode) {
        Money m = new Money();
        m.setCent(1);
    ...
    public static void main(String args[]) {
        Money m1 = new Money(10.515, Currency.getInstance("USD"));
        System.out.println("cent: " + m1.getCent());
        System.out.println("currencyCode: " + m1.getCurrencyCode());
        System.out.println("symbol: " + m1.getCurrency().getSymbol(Locale.US));
    }
}
